...
```
But is better to use an arrow function `setName(n => [...n, getName])` as a parameter don't want `...name` to be spread right when you run the application, only when you click.
